# DayZCommunityOfflineMode DeerIsle Edition 1.4
# (MAP Version: 4.0)
...
Download [this](https://github.com/CypherMediaGIT/DayZCommunityOfflineMode-DeerIsle-Edition/releases/download/1.4/DayZCommunityOfflineMode.deerisle.zip) zip archive.  
