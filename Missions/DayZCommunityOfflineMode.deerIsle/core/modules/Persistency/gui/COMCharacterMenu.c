class COMCharacterMenu extends UIScriptedMenu
{
	...
	override Widget Init()
	{
		...
		layoutRoot = GetGame().GetWorkspace().CreateWidgets( "$CurrentDir:missions\\DayZCommunityOfflineMode.deerIsle\\core\\modules\\Persistency\\gui\\layouts\\COMCharacterMenu.layout" );
