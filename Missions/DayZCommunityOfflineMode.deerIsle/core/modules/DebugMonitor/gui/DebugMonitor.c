class ArkDebugMonitor
{
	...
	{
		m_WidgetRoot = GetGame().GetWorkspace().CreateWidgets("$CurrentDir:missions\\DayZCommunityOfflineMode.deerIsle\\core\\modules\\DebugMonitor\\gui\\layouts\\day_z_debug_monitor.layout");
